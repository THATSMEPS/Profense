...
export default function VoiceSensor() {
  ...
  async function toggleRecording() {
    ...
    rec.onstop = async () => {
      ...
      try {
        ...
        if (data.text) {
          // A crude proxy: faster speech (short pause) -> lower rms, higher cadence
          // We use current voice_rms as a signal, transcription length as engagement
  ...
  return (
    <div className="card">
      ...
      <p><small>Measures voice intensity and sends snippets for Whisper transcription.</small></p>
    </div>
  );
}
